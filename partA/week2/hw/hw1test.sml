...
val test1_3 = is_older ((2,2,3), (1,2,3)) = false
...
val test8_1 = number_before_reaching_sum (16, [1,2,3,4,5]) = 6
...
val test11c = oldest([(2012,2,28),(2011,3,31)]) = SOME (2011,3,31)
val test11d = oldest([(2010,2,28),(2011,3,31)]) = SOME (2010,2,28)
